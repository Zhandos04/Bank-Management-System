...
import org.example.bankmanagementsystem.config.CustomAuthenticationProvider;
import org.example.bankmanagementsystem.dto.requests.*;
import org.example.bankmanagementsystem.dto.responses.AuthDTO;
import org.example.bankmanagementsystem.exceptions.UserAlreadyExistsException;
import org.example.bankmanagementsystem.jwt.JwtService;
import org.example.bankmanagementsystem.services.EmailService;
import org.example.bankmanagementsystem.services.TokenBlacklistService;
...
//    }
    ...
    public ResponseEntity<?> login(@RequestBody LoginDTO loginDTO) {
        ...
        authDTO.setRole(userOptional.get().getRole().name());
